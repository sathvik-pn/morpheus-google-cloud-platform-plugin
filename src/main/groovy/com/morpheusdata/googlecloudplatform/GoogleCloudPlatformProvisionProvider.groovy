...
class GoogleCloudPlatformProvisionProvider extends AbstractProvisionProvider implements WorkloadProvisionProvider {
	public static final String PROVISION_PROVIDER_CODE = 'google-cloud-platform-plugin.provision'

	protected MorpheusContext context
	protected Plugin plugin

	public GoogleCloudPlatformProvisionProvider(Plugin plugin, MorpheusContext ctx) {
		super()
		this.@context = ctx
		this.@plugin = plugin
	}
	...
	@Override
	String getName() {
		return 'Google Cloud Platform Provisioning'
	}
}
